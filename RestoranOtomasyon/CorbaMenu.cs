...
{
    public partial class CorbaMenu : Form
    {
        ...
        public void Menuolustur()
        {
            ...
            try
            {
                using (MySqlConnection baglanti = new MySqlConnection("server=localhost;uid=root;password=1234m;database=restorantys"))
                {
                    ...
                    {
                        string sqlquery = "SELECT UrunID FROM urunler WHERE KategoriID = 5";
                        ...
                        while (reader.Read())
                        {
                            ...
                            panel_Corba.Controls.Add(menu1);
                            menus.Add(menu1);
                        }
        ...
        private void CorbaMenu_Load(object sender, EventArgs e)
        {
            Menuolustur();
        }
    }
